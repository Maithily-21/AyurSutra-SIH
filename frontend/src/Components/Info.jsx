  ...
  return (
    <div className="info-section" id="services">
      <div className="info-title-content">
        ...
        We blend traditional Ayurvedic knowledge with advanced technology to deliver personalized wellness support.
        Our chatbot identifies your Prakriti, or body constitution, and provides customized diet and lifestyle suggestions
        to help you maintain balance and harmony in your daily life.
        </p>
      </div>
      ...
      <div className="info-cards-content">
        <InformationCard
          ...
          image={vataImg}
          colorclass={"bg-[#120c07] border-amber-400"}
        />
        ...
        <InformationCard
          ...
          image={pittaImg}
          colorclass={"bg-[#1a0b00] border-orange-500"}
        />
        ...
        <InformationCard
          ...
          image={kaphaImg}
          colorclass={"bg-[#0d0f1a] border-amber-300"}
        />
      </div>
    </div>
  );
