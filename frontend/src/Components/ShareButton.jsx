  ...
  const handleOnClick = async () => {
    try {
      await window.navigator.share({
        text: `*My Prakriti is ${dosha}*\n\nWhat's yours? You can also discover your Prakriti on AyurSutra.\n\nCheck now! 👉 ${window.location.href}\n\nEver wondered about your Prakriti? I found out I'm ${dosha}! Head over to AyurSutra to reveal yours! 🔍`,
      });
    } catch (e) {
      alert(
